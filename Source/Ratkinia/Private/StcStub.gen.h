...
namespace RatkiniaProtocol 
{
    ...
    public:
        ...
        virtual void OnRegisterResponse(uint64_t context, const RegisterResponse_FailedReason failed_reason) { static_cast<TDerivedStub*>(this)->OnUnhandledMessageType(context, StcMessageType::RegisterResponse); }
